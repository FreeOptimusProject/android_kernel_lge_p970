...
//veeru.sivangula@lge.com changed usb device name to LG P970 2011.11.04
#define LGE_B_USB_DEVICE_NAME		"P970"
...
static struct android_usb_product usb_products[] = {
	{
//veeru.sivangula@lge.com applied from Docomo B Proj 2011.11.04
// LGE_UPDATE_S 20110419 jaejoong.kim@lge.com 
...
#else	
// LGE_UPDATE_E 20110419 jaejoong.kim@lge.com
	{
...
//veeru.sivangula@lge.com changed product name  2011.11.04
#ifdef CONFIG_MACH_LGE_HUB
	.product_name		= "LGE P970 USB Device",
#else
...
// LGE_UPDATE_S 20110124 jaejoong.kim@lge.com usb porting for B project GB
	...
	.product	= "P970",//LGE_B_USB_DEVICE_NAME,  	// "OMAP4",
	.release	= 0xFFFF,
	.nluns		= 1,
// LGE_UPDATE_S 20110124 jaejoong.kim@lge.com usb porting for B project GB
};
//veeru.sivangula@lge.com changed product name as  LG P970 USB 2011.11.04
...
static void usb_gadget_init(void)
{
 ...
 //veeru.sivangula@lge.com applied from Docomo B Proj 2011.11.04
// LGE_UPDATE_S 20110429 [jaejoong.kim@lge.com] change usb serial num : chipset ID
...
// LGE_UPDATE_E 20110429 [jaejoong.kim@lge.com] change usb serial num : chipset ID
	if(0 > ret_check)
